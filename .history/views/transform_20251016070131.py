...
def app():
    ...
    with st.expander("💡 Terms"):
        st.write("""
        - [Trends](https://rhyslwells.github.io/Data-Archive/categories/data-science/Trends-in-Time-Series): Identify patterns in data
        ...
        - [Differencing](https://rhyslwells.github.io/Data-Archive/categories/data-science/Differencing-in-Time-Series): Removes trend and seasonality from data
                 """)
    ...
    with st.expander("💡 Terms"):
        ...
        - [Stationary](https://rhyslwells.github.io/Data-Archive/categories/data-science/Stationary-Time-Series): Time series data that is stationary has a constant mean and variance over time
        """)
