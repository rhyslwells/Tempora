...
def app():
    ...
    st.write("Generate [forecasts](https://rhyslwells.github.io/Data-Archive/categories/data-science/Time-Series-Forecasting) using various statistical and machine learning models.")
