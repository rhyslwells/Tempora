# use elements\01_data_prep.py to help
# I want to select the columns of the df I with to use on it then do transforms
## below is an example with tabs that i wish to copy
# I want to be able to select the columns i want to include
