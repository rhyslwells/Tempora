...
def show_decomposition(df: pd.DataFrame):
    ...
    with st.expander("💡 Terms"):
        st.write("""
        - [Seasonality](https://rhyslwells.github.io/Data-Archive/categories/data-science/Seasonality-in-Time-Series): Repeating patterns in time series data
        - [Additive vs Multiplicative Models](https://rhyslwells.github.io/Data-Archive/categories/data-science/Additive-vs-Multiplicative-Models-Time-Series): Two simple categories of time series models""")
