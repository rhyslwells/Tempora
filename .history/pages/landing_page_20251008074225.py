...
def app():
    ...
    This application provides a complete environment for **exploring, analyzing, and forecasting time series data** directly in your browser.

    The app is organized into focused workflows, allowing you to:
    
    1. **Explore Data**  
       Upload and visualize your time series data using interactive Plotly charts, moving averages, and decompositions.
    
    2. **Model Forecasts**  
       Build and compare forecasts using statistical models such as **Exponential Smoothing**, **ARIMA**, and **SARIMA** — with built-in grid search functionality for optimal parameter selection.
    
    3. **Evaluate Results**  
       Assess model performance with configurable metrics (e.g., MAE, RMSE, MAPE) and export both model parameters and evaluation summaries to CSV.
    ...
    5. Choose your **optimization metric** (e.g., AIC, RMSE, MAE) to find the best-performing configuration.  
